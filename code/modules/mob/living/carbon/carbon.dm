...
//AWWARE
/mob/living/carbon/proc/toggle_defense_mode()
	if (src.in_defense_mode)
		defense_act_off()
	else
		defense_act_on()

/mob/living/carbon/proc/defense_act_off()
	src.in_defense_mode = 0
	if(src.defense_icon)
		src.defense_icon.icon_state = "act_defense_off"

/mob/living/carbon/proc/defense_act_on()
	src.in_defense_mode = 1
	if(src.defense_icon)
		src.defense_icon.icon_state = "act_defense_on"
//AWWARE
