...
/datum/event/money_lotto/start()
	...
	if(all_money_accounts.len)
		...
		if(!D.suspended)
			...
			T.target_name = "Phoenix Station Daily Grand Slam -Stellar- Lottery"
			T.purpose = "Winner!"
			T.amount = winner_sum
...
/datum/event/money_lotto/announce()
	...
	newMsg.body = "Phoenix Station Daily wishes to congratulate <b>[winner_name]</b> for recieving the Phoenix Stellar Slam Lottery, and receiving the out of this world sum of [winner_sum] credits!"
	if(!deposit_success)
