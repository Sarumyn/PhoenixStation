	...
	if(candidates.len)
		...
		for (var/obj/effect/landmark/L in world)
			if(L.name == "voxstart")
				...
				to_chat(new_vox, "\blue You are a Vox Primalis, fresh out of the Shoal. Your ship has arrived at the Phoenix system hosting the NSV Exodus... or was it the Luna? NSS? Utopia? Nobody is really sure, but everyong is raring to start pillaging! Your current goal is: \red<B> [input]</B>")
