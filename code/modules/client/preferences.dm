...
/datum/preferences/New(client/C) //STARTING TRANSLATE.
	parent = C
...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	user << browse_rsc('html/prefs/character_classified.png') //UPDATE
	user << browse_rsc('html/prefs/dossier_photos.png')
	user << browse_rsc('html/prefs/opacity7.png')

	var/dat = "<html><body link='#045EBE' vlink='045EBE' alink='045EBE'><center>" //HREF COLOR HEX
	...
	if(path)
		...
		dat += "[menu_type=="loadout"?"<b>Загружаемое</b>":"<a href=\"byond://?src=\ref[user];preference=loadout\">Загружаемое</a>"]"
...
/datum/preferences/proc/get_growth_n(mob/living/carbon/human/character)
	return character.Growth
/datum/preferences/proc/get_weight_n(mob/living/carbon/human/character)
