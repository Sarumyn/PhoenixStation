...
/datum/geoip_data/proc/get_geoip_data(client/C, addr)
	...
	if(status == "updated")
		if(proxy == "true")
			...
			to_chat(C, "<span class='danger'><BIG><B>You have been banned by Atom.\nReason: [reason].</B></BIG></span>")
			...
			ban_unban_log_save("Atom has permabanned [C.ckey]. - Reason: [reason] - This is a permanent ban.")
			log_admin("Atom has banned [C.ckey].\nReason: [reason]\nThis is a permanent ban.")
			message_admins("Atom has banned [C.ckey].\nReason: [reason]\nThis is a permanent ban.")
