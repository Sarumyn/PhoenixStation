...
//end intent small hud objects
	...
	//AWWARE
	mymob.defense_icon = new /obj/screen()
	mymob.defense_icon.icon = ui_style
	mymob.defense_icon.icon_state = "act_defense_off"
	mymob.defense_icon.name = "defense"
	...
	//AWWARE 3
	mymob.client.screen += list( mymob.throw_icon, mymob.zone_sel, mymob.defense_icon, mymob.internals, mymob.healths, mymob.healthdoll, mymob.pullin, mymob.gun_setting_icon, lingchemdisplay, lingstingdisplay) //, mymob.hands, mymob.rest, mymob.sleep) //, mymob.mach )
