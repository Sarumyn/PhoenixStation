...
/obj/machinery/computer/vox_station/proc/vox_move_to(area/destination)
	...
	if(announce_vox_departure)
		if(curr_location == locate(/area/shuttle/vox/station))
			...
			command_alert("Your guests are pulling away, Exodus - moving too fast for us to draw a bead on them. Looks like they're heading out of Atom at a rapid clip.", "NSV Icarus")
