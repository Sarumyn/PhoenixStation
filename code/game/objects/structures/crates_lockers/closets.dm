/obj/structure/closet
	...
	var/close_sound = "sound/effects/locker_close.ogg" //UPDATE AWWARE
...
/obj/structure/closet/proc/open()
	...
	if(istype(src, /obj/structure/closet/body_bag))
		...
		playsound(src.loc, open_sound, 15, 1, -3) //AWWARE UPDATE
	density = 0
	return 1
...
/obj/structure/closet/proc/close()
	...
	if(istype(src, /obj/structure/closet/body_bag))
		...
		playsound(src.loc, close_sound, 25, 0, -3) //AWWARE UPDATE
	density = 1
	return 1
