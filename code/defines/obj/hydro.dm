...
//NEW APPLES SEED
/obj/item/seeds/apple_quadelis_seed
	name = "pack of apple quadelis seeds"
	desc = "WARNING : Very robust plant..."
	icon_state = "seed-quadelis_apple"
	mypath = "/obj/item/seeds/apple_quadelis_seed"
	species = "apple"
	plantname = "Quadelis Apple Tree"
	productname = "/obj/item/weapon/reagent_containers/food/snacks/grown/apple"
	lifespan = 55
	endurance = 35
	maturation = 6
